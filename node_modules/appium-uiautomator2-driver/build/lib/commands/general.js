...
function isExecuteMethod(script) {
    return script in driver_2.AndroidUiautomator2Driver.executeMethodMap;
}
/**
...
const GeneralMixin = {
    async getPageSource() {
        return String(await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/source', 'GET', {}));
    },
    async getClipboard() {
        const adb = /** @type {ADB} */ (this.adb);
        return String((await adb.getApiLevel()) < 29
            ? await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/device/get_clipboard', 'POST', {})
            : await adb.getClipboard());
    },
    async doSendKeys(params) {
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/keys', 'POST', params);
    },
    ...
    async getDisplayDensity() {
        return /** @type {number} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/device/display_density', 'GET', {}));
    },
    async getWindowSize() {
        return /** @type {import('@appium/types').Size} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/window/current/size', 'GET', {}));
    },
    // For W3C
    async getWindowRect() {
    ...
    async openNotifications() {
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/device/open_notifications', 'POST', {});
    },
    /**
    ...
    suspendChromedriverProxy() {
        ...
        this.proxyReqRes = /** @type {UiAutomator2Server} */ (this.uiautomator2).proxyReqRes.bind(this.uiautomator2);
    ...
    async mobileGetDeviceInfo() {
        return /** @type {StringRecord} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/device/info', 'GET'));
    },
    /**
