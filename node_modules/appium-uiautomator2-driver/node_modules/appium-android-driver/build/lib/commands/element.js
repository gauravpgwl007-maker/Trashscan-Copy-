...
const ElementMixin = {
    async getAttribute(attribute, elementId) {
        ...
        return await /** @type {AndroidBootstrap} */ (this.bootstrap).sendAction('element:getAttribute', p);
    },
    ...
    async doSetElementValue(params) {
        return await /** @type {AndroidBootstrap} */ (this.bootstrap).sendAction('element:setText', params);
    },
    ...
    async getLocation(elementId) {
        return await /** @type {AndroidBootstrap} */ (this.bootstrap).sendAction('element:getLocation', { elementId });
    },
    ...
    async touchLongClick(elementId, x, y, duration) {
        ...
        helpers_1.AndroidHelpers.removeNullProperties(params);
        return await /** @type {AndroidBootstrap} */ (this.bootstrap).sendAction('element:touchLongClick', params);
    },
    async touchDown(elementId, x, y) {
        let params = { elementId, x, y };
        helpers_1.AndroidHelpers.removeNullProperties(params);
        return await /** @type {AndroidBootstrap} */ (this.bootstrap).sendAction('element:touchDown', params);
    },
    async touchUp(elementId, x, y) {
        let params = { elementId, x, y };
        helpers_1.AndroidHelpers.removeNullProperties(params);
        return await /** @type {AndroidBootstrap} */ (this.bootstrap).sendAction('element:touchUp', params);
    },
    async touchMove(elementId, x, y) {
        let params = { elementId, x, y };
        helpers_1.AndroidHelpers.removeNullProperties(params);
        return await /** @type {AndroidBootstrap} */ (this.bootstrap).sendAction('element:touchMove', params);
    },
