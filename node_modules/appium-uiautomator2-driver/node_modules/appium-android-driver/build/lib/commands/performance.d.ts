 ...
 */
export function getBatteryInfo(this: import("../driver").AndroidDriver<import("../driver").AndroidSettings, import("../driver").AndroidDriverCreateResult>, retries?: number): Promise<string[][] | null>;
/**
 ...
 */
export function getCPUInfo(this: import("../driver").AndroidDriver<import("../driver").AndroidSettings, import("../driver").AndroidDriverCreateResult>, packageName: string, retries?: number): Promise<[typeof CPU_KEYS, [user: string, kernel: string]]>;
/**
 *
 * @this {AndroidDriver}
 ...
 * @param {number} retries
 */
export function getMemoryInfo(this: import("../driver").AndroidDriver<import("../driver").AndroidSettings, import("../driver").AndroidDriverCreateResult>, packageName: string, retries?: number): Promise<any[][] | null>;
/**
 * @this {AndroidDriver}
 * @param {number} retries
 */
export function getNetworkTrafficInfo(this: import("../driver").AndroidDriver<import("../driver").AndroidSettings, import("../driver").AndroidDriverCreateResult>, retries?: number): Promise<(string | undefined)[][] | null>;
/**
